"""
main.py - FastAPI service that serves live predictions from the
...
Endpoint is versioned (/v1/predict), so a future breaking change to
the input schema could be introduced as /v2/predict without breaking
whatever is already calling /v1.
"""
